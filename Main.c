...
void tipoIngreso() {
    printf("\n");
    printf("\tSeleccione la forma en la que quiere ingresar los datos:\n\n");
    printf("\t1\tDocumento en la misma carpeta que el programa\n");
    printf("\t2\tIngreso manual o copia pega\n");
    printf("\t3\tAtras\n\n");
}

void ingresoNombreDocumento() {
    printf("\n");
    printf("\tIntroduzca el nombre del documento:\n\n\t");
}

void ingresoCopiaDatos() {
    printf("\n");
    printf("\tIntroduzca los datos tal y como aparecen en el fichero:\n\n\t");
}